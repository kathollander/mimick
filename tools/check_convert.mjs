...
check("File lists Open, Find, Save, Export notes and Convert to MP3", JSON.stringify(labels) === JSON.stringify(["Open…", "Find in document…", "Save a copy (PDF)…", "Export notes…", "Convert to MP3…"]), labels);

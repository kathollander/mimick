 ...
 *   { type: "progress", id, done, total }   how far a slide deck has got, as it
 *       is laid out; sent before the { type: "called" } that answers the same id
...
function call(py, { id, name, args = [] }) {
  ...
  // document_to_pdf takes one, and only a deck calls it.
  const extra = name === "document_to_pdf"
